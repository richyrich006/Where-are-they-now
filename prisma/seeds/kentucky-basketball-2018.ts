...
export const kentuckyBasketball2018: TeamSeed = {
  ...
  people: [
    ...
    },
    {
      ...
      isFeatured: false,
      bio: "A 6-10 British-American power forward who played two seasons at Kentucky before transferring to NC State. Shot 58.4% from the floor as a sophomore, averaging 3.3 PPG and 2.9 RPG.",
      status: {
        occupationType: "ACTIVE_PRO_ATHLETE",
        ...
        statusNote: "After leaving NC State before becoming eligible in 2019, Killeya-Jones launched a professional career in Europe and Asia. He played in Estonia (Kalev/Cramo), Poland (MKS Dabrowa Gornicza — where he tore his patellar tendon in January 2021), and Israel (Hapoel Gilboa Galil, leading the Israeli league in scoring at 18.4 PPG in 2021-22). He signed an NBA two-way contract with the Oklahoma City Thunder in 2022, then landed in Japan's B.League with Kawasaki Brave Thunders, where he set a career high of 33 points and 10 rebounds with 9 blocks in one game in January 2025.",
        sourceUrl: "https://en.wikipedia.org/wiki/Sacha_Killeya-Jones",
      },
      membership: { role: "PLAYER", jerseyNumber: 1, position: "Power Forward", yearsAtSchool: "2016-2018", statsNote: "Sophomore • 3.3 PPG, 2.9 RPG • 58.4% FG • Transferred to NC State" },
      seasonStats: [
        { level: "HIGH_SCHOOL", teamName: "Brewster Academy", season: "Senior", yearLabel: "Senior", sortOrder: 1, pointsPerGame: 15.0, reboundsPerGame: 8.0, blocksPerGame: 2.0 },
        { level: "COLLEGE", teamName: "Kentucky Wildcats", season: "2016-2017", yearLabel: "Freshman", sortOrder: 201, gamesPlayed: 19, pointsPerGame: 1.5, reboundsPerGame: 1.4, assistsPerGame: 0.1 },
        { level: "COLLEGE", teamName: "Kentucky Wildcats", season: "2017-2018", yearLabel: "Sophomore", sortOrder: 202, gamesPlayed: 34, pointsPerGame: 3.3, reboundsPerGame: 2.9, assistsPerGame: 0.2, fieldGoalPct: 0.584 },
      ],
      careerEvents: [
        { year: 2018, title: "Transferred to NC State", eventType: "OTHER" },
        { year: 2022, title: "Signed two-way contract with Oklahoma City Thunder", eventType: "SIGNING" },
      ],
    },
    {
      slug: "marcus-lee",
      ...
      highSchool: "Foothills Christian School, El Cajon, CA",
      isFeatured: false,
      bio: "A 6-9 forward who played three seasons at Kentucky before transferring to Cal, where he blossomed into a starter averaging 11.4 PPG and 7.2 RPG as a redshirt senior.",
      status: {
        occupationType: "ACTIVE_PRO_ATHLETE",
        currentTitle: "Forward",
        currentEmployer: "Melbourne United",
        league: "NBL Australia",
        location: "Melbourne, Australia",
        statusNote: "After going undrafted in 2018, Lee played for the Sioux Falls Skyforce (G League) and had NBA Summer League stints with Cleveland and Miami. He has since built a solid overseas career across the Turkish Basketball Super League (Semt77 Yalovaspor), Puerto Rico (Leones de Ponce), Spain's Liga ACB (Baxi Manresa), and most recently returned to Melbourne United in Australia's NBL for a second stint beginning August 2024.",
        sourceUrl: "https://www.basketball-reference.com/players/l/leema02.html",
      },
      membership: { role: "PLAYER", jerseyNumber: 0, position: "Forward", yearsAtSchool: "2014-2017", statsNote: "Junior • Role player • Transferred to Cal" },
      seasonStats: [
        { level: "HIGH_SCHOOL", teamName: "Foothills Christian School", season: "Senior", yearLabel: "Senior", sortOrder: 1, pointsPerGame: 15.0, reboundsPerGame: 10.0, blocksPerGame: 2.0 },
        { level: "COLLEGE", teamName: "Kentucky Wildcats", season: "2015-2016", yearLabel: "Sophomore", sortOrder: 201, gamesPlayed: 36, pointsPerGame: 4.2, reboundsPerGame: 4.2, assistsPerGame: 0.4 },
        { level: "COLLEGE", teamName: "California Golden Bears", season: "2017-2018", yearLabel: "Redshirt Senior (Cal)", sortOrder: 202, gamesPlayed: 32, pointsPerGame: 11.4, reboundsPerGame: 7.2, assistsPerGame: 1.3, blocksPerGame: 1.6 },
      ],
      careerEvents: [
        { year: 2016, title: "Transferred from Kentucky to California", eventType: "OTHER" },
        { year: 2018, title: "Went undrafted; signed with Sioux Falls Skyforce (G League)", eventType: "CAREER" },
        { year: 2024, title: "Re-signed with Melbourne United (NBL Australia)", eventType: "SIGNING" },
      ],
    },
    {
      ...
      isFeatured: false,
      bio: "Coach Calipari's son who walked on at Kentucky and played three seasons before transferring to Detroit Mercy as a graduate transfer.",
      status: {
        occupationType: "COACH",
        currentTitle: "Assistant Coach / Director of Player Development",
        currentEmployer: "University of Arkansas",
        location: "Fayetteville, AR",
        statusNote: "Brad walked on at Kentucky and appeared in 60 career games, averaging 0.3 PPG. After redshirting in 2018-19, he transferred to Detroit Mercy for his final two seasons. He now serves on his father John Calipari's staff at the University of Arkansas as an assistant coach and director of player development.",
        sourceUrl: "https://arkansasrazorbacks.com/coache/brad-calipari/",
      },
      membership: { role: "PLAYER", jerseyNumber: 12, position: "Guard", yearsAtSchool: "2016-2019", statsNote: "Sophomore walk-on • Son of Coach Calipari • 0.3 PPG" },
      seasonStats: [
        ...
        { level: "COLLEGE", teamName: "Kentucky Wildcats", season: "2017-2018", yearLabel: "Sophomore walk-on", sortOrder: 201, gamesPlayed: 12, pointsPerGame: 0.3, reboundsPerGame: 0.2, assistsPerGame: 0.1 },
      ],
      careerEvents: [
        { year: 2021, title: "Graduated from Detroit Mercy", eventType: "OTHER" },
        { year: 2024, title: "Joined Arkansas staff under father John Calipari", eventType: "CAREER" },
      ],
    },
    {
      slug: "ej-montgomery-2018",
      firstName: "EJ",
      lastName: "Montgomery",
      birthYear: 1999,
      ...
      isFeatured: false,
      bio: "A highly recruited five-star forward from the 2018 class (RSCI Top 10) who arrived at Kentucky as a freshman and played two seasons before declaring for the NBA Draft.",
      status: {
        occupationType: "ACTIVE_PRO_ATHLETE",
        currentTitle: "Professional Basketball Player",
        ...
        location: "Poland",
        statusNote: "Went undrafted in 2020 after two seasons at Kentucky. Has played in the G League (Birmingham Squadron) and has carved out an overseas career in Europe. Currently averaging 7.4 PPG and 7.9 RPG with MKS Dabrowa Gornicza in Poland's PLK.",
        sourceUrl: "https://www.proballers.com/basketball/player/178401/montgomery-e-j",
      },
      membership: { role: "PLAYER", jerseyNumber: 23, position: "Forward", yearsAtSchool: "2018-2020", statsNote: "Freshman • RSCI Top 10 recruit • 3.8 PPG, 4.1 RPG" },
      seasonStats: [
        ...
        { level: "COLLEGE", teamName: "Kentucky Wildcats", season: "2017-2018", yearLabel: "Freshman", sortOrder: 201, gamesPlayed: 35, pointsPerGame: 3.8, reboundsPerGame: 4.1, assistsPerGame: 0.4, blocksPerGame: 1.0 },
      ],
      careerEvents: [
