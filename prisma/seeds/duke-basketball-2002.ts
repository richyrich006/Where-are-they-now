...
export const dukeBasketball2002: TeamSeed = {
  ...
  people: [
    ...
    },
    {
      ...
      isFeatured: false,
      bio: "Duke's lone senior in 2001-02, a physical inside presence who won the 2001 national championship and was awarded the Coaches' Award for best embodying the spirit of Duke Basketball in his final year.",
      status: {
        occupationType: "ENTREPRENEUR_BUSINESS",
        currentTitle: "Co-Founder, CEO & Managing Partner",
        currentEmployer: "Rose Park Advisors",
        location: "Boston, MA",
        linkedInUrl: "https://www.linkedin.com/in/matthewchristensen41/",
        statusNote:
          "After earning a double major in Economics and Civil Engineering at Duke and winning the 2002 Coaches' Award, Christensen earned his MBA from Harvard Business School. He co-founded Rose Park Advisors with his father, the late Prof. Clayton Christensen of Harvard Business School — the pioneer of Disruptive Innovation theory — to apply that framework to long-term equity investing. He previously worked at Innosight, the strategy consultancy founded by Prof. Christensen. Rose Park has operated for over 15 years; Matt remains CEO and Managing Partner. He also serves on Duke's Pratt School of Engineering Board of Visitors.",
      ...
      membership: {
        ...
        yearsAtSchool: "1998-2002",
        statsNote: "Senior • Coaches' Award winner • National champion • 1.7 PPG, 1.9 RPG career",
        gamesPlayed: 31,
        pointsPerGame: 2.1,
        reboundsPerGame: 2.3,
      },
      seasonStats: [
        { level: "HIGH_SCHOOL", teamName: "Belmont Hill School", season: "Senior", yearLabel: "Senior", sortOrder: 1, pointsPerGame: 14.0, reboundsPerGame: 8.0, blocksPerGame: 2.0 },
        { level: "COLLEGE", teamName: "Duke Blue Devils", season: "2000-2001", yearLabel: "Junior (National Champion)", sortOrder: 202, gamesPlayed: 36, pointsPerGame: 1.3, reboundsPerGame: 1.5, assistsPerGame: 0.1 },
        { level: "COLLEGE", teamName: "Duke Blue Devils", season: "2001-2002", yearLabel: "Senior (Coaches' Award)", sortOrder: 203, gamesPlayed: 31, pointsPerGame: 2.1, reboundsPerGame: 2.3, assistsPerGame: 0.1 },
      ],
      careerEvents: [
        { year: 2001, title: "Won NCAA National Championship with Duke", eventType: "CHAMPIONSHIP" },
        { year: 2002, title: "Won Duke Coaches' Award; graduated with double major in Econ & Civil Engineering", eventType: "AWARD" },
        { year: 2009, title: "Co-founded Rose Park Advisors with father Clayton Christensen", eventType: "CAREER" },
      ],
    },
    {
      slug: "mark-causey",
      ...
      highSchool: "East Hall High School, Gainesville, GA",
      isFeatured: false,
      bio: "A walk-on freshman guard from Gainesville, Georgia who joined the Blue Devils for the 2001-02 season and went on to become a board-certified orthodontist.",
      status: {
        occupationType: "OTHER",
        currentTitle: "Owner / Orthodontist",
        currentEmployer: "Causey Orthodontics",
        location: "Gainesville, GA",
        linkedInUrl: "https://www.linkedin.com/in/mark-causey-79599667/",
        statusNote:
          "After his one season at Duke, Causey transferred to North Georgia College & State University (now University of North Georgia), where he played basketball and graduated with honors with a degree in Biology. He then attended the Medical College of Georgia School of Dentistry and completed an orthodontic residency. A board-certified orthodontist, he served as faculty at the Dental College of Georgia for nearly eight years and continues to teach at the Charles H. Tweed International Foundation for Orthodontic Research. He now runs Causey Orthodontics in his home community of Gainesville, GA, where he grew up and is raising his family.",
        sourceUrl: "https://causeyorthodontics.com/meet-dr-causey/",
      },
      membership: {
        role: "PLAYER",
        jerseyNumber: 53,
        position: "Guard",
        yearsAtSchool: "2001-2002",
        statsNote: "Freshman walk-on • 12 games • 1.1 PPG",
        gamesPlayed: 12,
        pointsPerGame: 1.1,
        reboundsPerGame: 0.7,
      },
      seasonStats: [
        { level: "HIGH_SCHOOL", teamName: "East Hall High School", season: "Senior", yearLabel: "Senior", sortOrder: 1, pointsPerGame: 9.0, reboundsPerGame: 3.0, assistsPerGame: 2.0 },
        { level: "COLLEGE", teamName: "Duke Blue Devils", season: "2001-2002", yearLabel: "Freshman walk-on", sortOrder: 201, gamesPlayed: 12, pointsPerGame: 1.1, reboundsPerGame: 0.7, assistsPerGame: 0.3 },
      ],
      careerEvents: [
        { year: 2002, title: "Transferred to North Georgia College & State University", eventType: "CAREER" },
      ],
    },
    {
