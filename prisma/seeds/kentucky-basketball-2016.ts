...
export const kentuckyBasketball2016: TeamSeed = {
  ...
  people: [
    ...
    },
    {
      ...
      isFeatured: false,
      bio: "A walk-on guard who came from a family of Olympians — his father Edrick competed for Canada in the 1988 and 1992 Olympics, and his mother was a silver medalist in the 1992 Olympic hurdles. Floréal moved from Palo Alto to Lexington as a senior to be closer to his father, who coached Kentucky's track program.",
      status: {
        occupationType: "OTHER",
        currentTitle: "Private Sector / Track & Field",
        location: "Lexington, KY",
        statusNote:
          "A walk-on guard who played 29 games over three seasons at Kentucky (2013-16), appearing in three NCAA Tournament teams including trips to the 2014 and 2015 Final Fours and the 2016 SEC Tournament champions. In August 2016, Floréal left the basketball team to join his father Edrick's track and field program at Kentucky, where he competed as a sprinter. His family is Olympic royalty — his mother was a silver medalist in the 1992 Barcelona Olympics in the 100m hurdles. He has remained in the Lexington area.",
        sourceUrl: "https://www.espn.com/mens-college-basketball/story/_/id/17257435/ej-floreal-leave-basketball-run-track-kentucky",
      },
      membership: {
        role: "PLAYER",
        jerseyNumber: 11,
        ...
        statsNote: "Walk-on • 3 pts, 8 reb career • Olympian family • Switched to track",
        gamesPlayed: 10,
        pointsPerGame: 0.3,
        reboundsPerGame: 0.8,
        assistsPerGame: 0.0,
      ...
      seasonStats: [
        { level: "HIGH_SCHOOL", teamName: "Paul Laurence Dunbar High School", season: "2012-13", yearLabel: "Senior", sortOrder: 101, pointsPerGame: 11.2, reboundsPerGame: 3.1, assistsPerGame: 2.5 },
        { level: "COLLEGE", teamName: "Kentucky Wildcats", season: "2015-2016", yearLabel: "Junior", sortOrder: 201, gamesPlayed: 10, pointsPerGame: 0.3, reboundsPerGame: 0.8, assistsPerGame: 0.0 },
      ],
      careerEvents: [
        { year: 2014, title: "Part of Kentucky's Final Four team", eventType: "CAREER" },
        { year: 2015, title: "Part of Kentucky's Final Four team", eventType: "CAREER" },
        { year: 2016, title: "Left basketball to compete in track & field at Kentucky", eventType: "CAREER_CHANGE" },
      ],
    },
    {
      slug: "dillon-pulliam",
      ...
      isFeatured: false,
      bio: "A walk-on guard who was a former high school valedictorian and computer engineering major. One of the most academically accomplished walk-ons in college basketball history.",
      status: {
        occupationType: "OTHER",
        ...
        statusNote:
          "One of college basketball's most remarkable academic achievers. A former high school valedictorian who was also a walk-on basketball player at Kentucky, Pulliam maintained a 4.0 GPA in computer engineering while practicing with one of the most talented squads in college basketball history. He transferred from Transylvania University (where he averaged 4.8 PPG) and had to sit out 2015-16 per NCAA transfer rules before eventually suiting up for the Wildcats. Left Kentucky early to pursue his MBA at Carnegie Mellon, one of the country's top engineering programs. Now a technology professional.",
      ...
      membership: {
        ...
        statsNote: "Walk-on • Redshirt 2015-16 • Valedictorian • 4.0 GPA computer engineering",
        gamesPlayed: 0,
        pointsPerGame: 0.0,
        reboundsPerGame: 0.0,
        assistsPerGame: 0.0,
      ...
      seasonStats: [
        ...
        { level: "COLLEGE", teamName: "Transylvania University", season: "2013-14", yearLabel: "Transfer (Transylvania)", sortOrder: 151, gamesPlayed: 25, pointsPerGame: 4.8, reboundsPerGame: 3.4, assistsPerGame: 0.8 },
        { level: "COLLEGE", teamName: "Kentucky Wildcats", season: "2015-2016", yearLabel: "Redshirt (sit-out year)", sortOrder: 201, gamesPlayed: 0, pointsPerGame: 0.0, reboundsPerGame: 0.0, assistsPerGame: 0.0 },
      ],
      careerEvents: [
        { year: 2015, title: "Transferred to Kentucky from Transylvania; sat out per NCAA rules", eventType: "OTHER" },
    ...
    },
    {
      ...
      highSchool: "Mt. Lebanon High School, Mt. Lebanon, PA",
      isFeatured: false,
      bio: "A walk-on guard from Pittsburgh who passed up Division I scholarship offers to walk on at Kentucky. Averaged 18.5 PPG at Mt. Lebanon High School and earned a degree in kinesiology.",
      status: {
        occupationType: "OTHER",
        currentTitle: "Private Sector",
        location: "Pittsburgh, PA",
        statusNote:
          "A Pittsburgh-area guard who averaged 18.5 PPG at Mt. Lebanon High School and passed up Division I scholarship offers to walk on for John Calipari's Kentucky program. He appeared in 33 career games across four seasons (2015-19), earning a career-high 14 minutes during his senior season in 2018-19. He graduated from Kentucky in May 2019 with a degree in kinesiology. His time at Kentucky included appearances in two NCAA Tournaments. He has since returned to the Pittsburgh area.",
        sourceUrl: "https://www.aseaofblue.com/2015/8/26/9210279/kentucky-basketball-jonny-david-dillon-pulliam-walk-ons",
      },
      membership: {
        role: "PLAYER",
        jerseyNumber: 4,
        ...
        statsNote: "Walk-on • 33 career games • Kinesiology degree • Pittsburgh native",
        gamesPlayed: 8,
        pointsPerGame: 0.5,
        reboundsPerGame: 0.4,
        assistsPerGame: 0.3,
      ...
      seasonStats: [
        { level: "HIGH_SCHOOL", teamName: "Mt. Lebanon High School", season: "2014-15", yearLabel: "Senior", sortOrder: 101, pointsPerGame: 18.5, reboundsPerGame: 4.5, assistsPerGame: 3.0 },
        { level: "COLLEGE", teamName: "Kentucky Wildcats", season: "2015-2016", yearLabel: "Freshman walk-on", sortOrder: 201, gamesPlayed: 8, pointsPerGame: 0.5, reboundsPerGame: 0.4, assistsPerGame: 0.3 },
      ],
      careerEvents: [
        { year: 2015, title: "Enrolled at Kentucky as walk-on guard, passing up D-I scholarship offers", eventType: "OTHER" },
        { year: 2019, title: "Graduated from Kentucky with kinesiology degree", eventType: "CAREER" },
      ],
    },
    {
      slug: "kenny-payne",
