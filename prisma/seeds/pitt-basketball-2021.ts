...
export const pittBasketball2021: TeamSeed = {
  slug: "pitt-basketball-2021",
  ...
  people: [
    {
      ...
      seasonStats: [
        { level: "COACHING", teamName: "Pittsburgh Panthers", season: "2020-2021", yearLabel: "2020-2021", sortOrder: 213 },
      ],
      careerEvents: [],
    },
  ],
