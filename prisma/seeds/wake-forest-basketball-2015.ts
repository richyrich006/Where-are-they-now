...
export const wakeForestBasketball2015: TeamSeed = {
  slug: "wake-forest-basketball-2015",
  ...
  people: [
    {
      ...
      seasonStats: [
        { level: "COACHING", teamName: "Wake Forest Demon Deacons", season: "2014-2015", yearLabel: "2014-2015", sortOrder: 207 },
      ],
      careerEvents: [],
    },
  ],
